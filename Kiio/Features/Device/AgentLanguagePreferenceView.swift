...
struct AgentLanguagePreferenceView: View {
    ...
    private let languages: [AgentLanguageOption] = [
        AgentLanguageOption(code: "zh_CN", displayCode: "zh-CN", flag: "CN", nameKey: "settingsLanguage.zhCn", previewKey: "settingsLanguage.previewZh"),
        AgentLanguageOption(code: "en_US", displayCode: "en-US", flag: "EN", nameKey: "settingsLanguage.enUs", previewKey: "settingsLanguage.previewEn")
    ]
    ...
    var body: some View {
        ...
        .task {
            selected = normalizedLocale(bootstrapStore.preference?.agentLanguage ?? appState.locale)
        }
